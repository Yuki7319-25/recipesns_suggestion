...
urlpatterns = [
    ...
    path('today-menu/', accounts_views.calc_view, name='today_menu'),
    path('accounts/', include('accounts.urls')),  # ← accounts の URL をまとめて読み込む
    path('', include('photo.urls')),              # ← photo アプリの URL
